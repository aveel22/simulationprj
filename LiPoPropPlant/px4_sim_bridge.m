function throttles = px4_sim_bridge(sensor_data)
...
persistent server_sock client_sock in_strm out_strm ...
           ...
           rx_buf last_throttles init_flag time_offset
...
if ~is_connected
    try
        ...
        is_connected = true;
        time_offset = sensor_data(20);  % zero timestamps from connection time
        fprintf('[px4_sim_bridge] *** PX4 connected at t=%.2fs ***\n', time_offset);
    catch
...
time_usec = uint64((sim_time_s - time_offset) * 1e6);
